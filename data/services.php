...
// Service pages — one per keyword cluster. Edit the copy here, then commit & push.
// Fields: slug, kicker, title (H1), tagline, meta_description, intro (answer-first,
// quotable paragraph), offerings (list of title + description), faq (3-4 Q&A),
// service_type (schema.org Service type), area_served.
